df = read.csv("L:/BUT/SD/Promo 2023/elitherland/R/NBA2014_2015.csv", header = TRUE, dec = ".", sep = ",")
nrow(df)
ncol(df)
colnames(df)
...
build_graph(df$PTS_MARQUES,"répartition des points")
table(df$PTS_MARQUES)
